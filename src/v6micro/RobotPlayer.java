...
public strictfp class RobotPlayer {
    ...
    public static void play(RobotController rc) throws GameActionException {
        ...
        //micro(rc);
        firstPartMicro(rc);
        microAttacker.doMicro(boomedStunInfos);
        macro(rc);
    ...
    static void getTask(RobotController rc, MapLocation fromLoc) throws GameActionException {
        ...
        if(flagLoc != null && task != null && fromLoc.distanceSquaredTo(task) > fromLoc.distanceSquaredTo(flagLoc)) {
            task = null;
        }
    }
    ...
    static void firstPartMicro(RobotController rc) throws GameActionException {
        RobotInfo target = attackTarget == null? backupTarget : attackTarget;
        if (target != null) {
